...
#merubah dari suatu tipe ke tipe lainnya
#tipe data= int, float, string, bool
#note: jika data int dan bool nya 0 maka akan menjadi false
#begitu juga sebaliknya yaitu jika tidak lebih atau
#kurang dari 0 makan akan menjadi true
